          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section>
              ...
              <ul className="space-y-2">
                {project.keyTechniques && project.keyTechniques.map(tech => (
            ...
            <div className="sticky top-28 bg-white p-6 rounded-lg shadow-md space-y-6">
              <div>
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  {project.leaderboardLink && (
                    <a href={project.leaderboardLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-green-600 font-medium hover:underline">
